 ...
 * @version 1.0
 */
public class BaseDynamicWindow {

    public static final String L_HEADER_MAIN_TITLE = "服务控制面板";
    public static final String L_HEADER_SUB_TITLE = "service control";
     ...
     * 窗口原始宽度，默认：300
     */
    public final int OriginSize_Width = 600;
    /**
     * 窗口原始高度，默认：570
     */
    public final int OriginSize_Height = 600;

    /**
     * 原始（基准）屏幕分辨率-长度，默认：1440
     */
    private final int OriginResolution_W = 1920;

    /**
     * 原始（基准）屏幕分辨率-高度，默认：900
     */
    private final int OriginResolution_H = 1080;
    ...
    public BaseDynamicWindow() {
        ...
        String confdir = path + File.separator + "config" + File.separator;
     ...
     * <h2>获取基准分辨率-宽度</h2>
     * <p>
     * 该宽度为开发时所使用的基准分辨率宽度。请以此宽度为基准进行窗口的设计。
     * </p>
     *
     * @return int 基准宽度-像素
     * @author devcp
     ...
     * <h2>获取基准分辨率-高度</h2>
     * <p>
     * 该高度为开发时所使用的基准分辨率宽度。请以此高度为基准进行窗口的设计。
     * </p>
     *
     * @return int 基准高度-像素
     * @author devcp
